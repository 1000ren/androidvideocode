...
public class NewsService {
	...
	public static boolean save(String title, String length) {
		String path = "http://192.168.1.102:8080/gp/ManageServlet";
		Map<String, String> params = new HashMap<String, String>();
		params.put("title", title);
		params.put("timelength", length);
		try {
//			return sendGETRequest(path, params,"GBK");
//			return sendPOSTRequest(path, params,"GBK");
			return sendHttpClientPOSTRequest(path, params,"GBK");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return false;
	 ...
	 * @return 请求是否成功
	 */
	private static boolean sendGETRequest(String path, Map<String, String> params,String ecoding) 
			throws Exception{
