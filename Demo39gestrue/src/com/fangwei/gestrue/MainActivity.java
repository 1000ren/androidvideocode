...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //只针对单笔手势：overlayView.addOnGesturePerformedListener
        //(new GesturePerformedListener());
